...
- **MUSS [MUST]** die Laufzeitberechtigung `CAMERA` deklarieren und vor dem Öffnen des Streams halten: AUSBC verweigert ab `targetSdk >= 28` jedes UVC-Gerät ohne sie, obwohl keine Plattformkamera beteiligt ist [M]; die Begründung gegenüber den Nutzenden **MUSS [MUST]** das Mikroskop erklären, nicht eine Selfie-Kamera
